              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4 group cursor-pointer p-4 rounded-lg hover:bg-white/5 transition-colors border border-transparent hover:border-white/5">
                  ...
                  <div>
                    ...
                    <div className="text-white font-medium group-hover:text-brand-primary transition-colors">ahmedaglan993@gmail.com</div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 group cursor-pointer p-4 rounded-lg hover:bg-white/5 transition-colors border border-transparent hover:border-white/5">
                  ...
                  <div>
                    ...
                    <div className="text-white font-medium group-hover:text-brand-secondary transition-colors">linkedin.com/in/ahmad-m-aglan</div>
                  </div>
                </div>
              </div>
            </div>
